...
class Game:
    ...
    def __init__(self):
        ...
        self.breaking_sound.set_volume(2.5) # Не обязательно
    ...
    def update(self):
        ...
        for platform in self.platforms.copy():
            ...
            if self.player.collide_sprite(platform):
                ...
                elif platform.type == "SuperPlatform":
                    self.player.jump_power = self.player.jump_power * 2
                if not platform.type == "SuperPlatform":
